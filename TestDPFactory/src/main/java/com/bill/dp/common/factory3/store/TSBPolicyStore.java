...
@Component
public class TSBPolicyStore extends PolicyStore {
	
	@Autowired
	TSBPolicyFactory factory;
	...
	public IPolicyDto createPolicy(String insTypeId, BaseWebReq baseWebReq) {
		Map<String, IPolicyDto> policyMap = new HashedMap<String, IPolicyDto>(){{
			...
			put("I02", factory.createVehiclePolicy(baseWebReq.getTranrq()));
			put("I03", factory.createVehiclePolicy(baseWebReq.getTranrq()));
		}};
